...
const ones = new TotalOneNumber({ val: 1, description: "1 point per 1s" });
const twos = new TotalOneNumber({ val: 2, description: "2 points per 2s" });
const threes = new TotalOneNumber({ val: 3, description: "3 points per 3s" });
const fours = new TotalOneNumber({ val: 4, description: "4 points per 4s" });
const fives = new TotalOneNumber({ val: 5, description: "5 points per 5s" });
const sixes = new TotalOneNumber({ val: 6, description: "6 points per 6s" });
